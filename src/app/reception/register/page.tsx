      ...
      {stage === "review" && (
        <Panel icon={CheckCircle2} title={t('register.reviewRegistration')}>
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            <Button variant="outline" onClick={() => setStage("details")} className="h-11 rounded-xl gap-1.5"><ArrowLeft className="h-4 w-4" /> {t('common.back')}</Button>
            <Button variant="outline" onClick={printSlip} className="h-11 rounded-xl gap-1.5"><Printer className="h-4 w-4" /> {t('register.printSlip')}</Button>
            <div className="flex-1" />
            <Button variant="secondary" onClick={() => addToQueue(false)} className="h-11 rounded-xl gap-1.5"><UserPlus className="h-4 w-4" /> {t('register.addToQueue')}</Button>
            <Button onClick={() => addToQueue(true)} className="h-11 rounded-xl gap-1.5"><Activity className="h-4 w-4" /> {t('register.addAndSendToVitals')}</Button>
          </div>
        </Panel>
      )}
