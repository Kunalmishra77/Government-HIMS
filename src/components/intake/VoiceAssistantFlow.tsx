    ...
    <div className="flex flex-col flex-1 h-full w-full">
      <header className="px-6 pt-6 pb-2 shrink-0">
        ...
        <div className="px-6 pb-6 pt-3 flex flex-col gap-2.5 border-t border-slate-100 bg-gradient-to-t from-[color:var(--color-background)] via-[color:var(--color-background)] shrink-0 z-20">
          <button onClick={onConfirm} className="w-full h-14 rounded-2xl font-semibold text-[17px] text-[#0D2032] bg-[#EE6B26] hover:bg-[#C2481A] transition-all shadow-[0_8px_20px_rgba(238,107,38,0.28)] active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#EE6B26]">
            {t.confirm}
          </button>
          <button onClick={onBack} className="w-full h-14 rounded-2xl font-semibold text-[15px] text-slate-600 bg-slate-100/50 hover:bg-slate-100 active:scale-[0.98] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#EE6B26]">
            {t.back}
          </button>
        </div>
    </div>
